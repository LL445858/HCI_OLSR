...
TIMEOUT_ASYMMETRIC_NEIGHBOR = 2
TIMEOUT_SYMMETRIC_NEIGHBOR = 6
TIMEOUT_TWO_HOP_NEIGHBOR = 6


class Node:
    """DC_OLSR协议节点类 - 定向OLSR路由（纯FSO通信）"""
    ...
    def receive_hello_message(self, source_node, message_size):
        """接收Hello消息，更新邻居关系"""
        self.communication_energy += calculate_communication_energy_energy(0, message_size * 8, 0, 'fso')
        self.energy_rate -= calculate_communication_energy_energy(0, message_size * 8, 0, 'fso')
